...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        ###     self.stack: The current stack represented as a list with the top
        # of the stack as the
...
def minibatch_parse(sentences, model, batch_size):
    ...
    @param batch_size (int): The number of PartialParses to include in each
    minibatch
    ...
    ###
    ###     Note: A shallow copy (as denoted in the PDF)
    # can be made with the "=" sign in python, e.g.
    ###                 unfinished_parses = partial_parses[:].
    ###             Here `unfinished_parses` is a shallow copy of `partial_parses`.
    ###             In Python, a shallow copied list like `unfinished_parses`
    # does not contain new instances
    ###             of the object stored in `partial_parses`. Rather both lists
    # refer to the same objects.
    ###             In our case, `partial_parses` contains a list of partial
    # parses. `unfinished_parses` contains references to the same objects.
    # Thus, you should NOT use the `del` operator
    ###             to remove objects from the `unfinished_parses` list.
    # This will free the underlying memory that
    ###             is being accessed by `partial_parses` and may cause your
    # code to crash.
